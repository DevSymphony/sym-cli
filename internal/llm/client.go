...
func (c *Client) initEngines() {
	...
	for _, reg := range GetAllRegistrations() {
...
func (c *Client) GetActiveEngine() LLMEngine {
...
func (c *Client) GetEngines() []LLMEngine {
	return c.engines
}
...
func (r *RequestBuilder) WithComplexity(c Complexity) *RequestBuilder {
	r.complexity = c
	return r
}
...
func (c *Client) executeWithFallback(ctx context.Context, req *Request) (string, error) {
	var lastErr error
...
func (c *Client) ExecuteDirect(ctx context.Context, eng LLMEngine, req *Request) (string, error) {
	if !eng.IsAvailable() {
